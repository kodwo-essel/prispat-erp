            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                    <section className="bg-white border border-border p-6 rounded-sm shadow-sm flex flex-col gap-6">
                        <div className="text-xs font-bold uppercase tracking-widest border-b border-border pb-4">Shipment Details</div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-muted border border-border px-3 py-2 rounded-sm text-xs min-h-[80px] focus:outline-none focus:border-primary"
                    ...
                    <section className="bg-primary text-white p-6 rounded-sm shadow-lg flex flex-col gap-4 sticky top-6">
                        <div className="text-[10px] font-bold uppercase tracking-widest opacity-80">Total Shipment Value</div>
                        <div className="text-3xl font-black tabular-nums">₵{calculateTotal().toLocaleString()}</div>
                        <div className="text-[10px] font-medium opacity-60 italic">Includes {formData.items.length} product entries</div>
                    </section>
                </div>
                                                    ...
                                                    <datalist id={`inventory-list-${index}`}>
                                                        {inventory.map(i => (
                                                            <option key={i._id} value={i.name}>
                                                                {i.sku} (Supplier: {i.supplier}) - Stock: {i.stock} {i.unit}
                                                            </option>
                                                        ))}
                                                    </datalist>
                                                </div>
