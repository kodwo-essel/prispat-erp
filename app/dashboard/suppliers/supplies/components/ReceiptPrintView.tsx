                ...
                <div className="flex justify-between items-start border-b-2 border-primary pb-8">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-2xl font-black uppercase tracking-tighter text-primary">Prispat Prime Distribution</h1>
                        </div>
                        <div className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em] flex flex-col gap-1">
                            <div className="flex items-center gap-2"><MapPin size={10} /> Plot 42, Industrial Area, Kumasi, Ghana</div>
                            <div>Digital Address: AK-000-4242</div>
                            <div>Contact: +233 24 000 0000 | logistics@prispat.com</div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 border-l border-slate-200 pl-12">
                        ...
                        <div className="pl-6">
                            <div className="text-lg font-bold text-slate-700">
                                {new Date(receipt.arrivalDate).toLocaleDateString("en-GB", {
                                    day: "2-digit",
                                    month: "long",
                                    year: "numeric"
                                })}
                            ...
                            <div className="text-[10px] text-secondary uppercase font-bold tracking-tight">
                                Arrival Recorded: {new Date(receipt.arrivalDate).toLocaleTimeString()}
                            </div>
                        </div>
                    </div>
                </div>
